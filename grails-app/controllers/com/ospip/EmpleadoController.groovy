...
class EmpleadoController {
    ...
    def save() {
		...
		empleadoInstance.paisOrigen = Pais.get(params.int('paisOrigenId'))
		empleadoInstance.provincia = Provincia.get(params.int('provinciaId'))
		empleadoInstance.localidad = Localidad.get(params.int('localidadId'))
		empleadoInstance.categoria = Categoria.get(params.int('categoriaId'))
		empleadoInstance.subcategoria = Subcategoria.get(params.int('subcategoriaId'))
