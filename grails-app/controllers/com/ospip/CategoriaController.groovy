...
class CategoriaController {
	...
	def obtenerSubcategorias = {
		def categoriaInstance = Categoria.get(params.int('id'))
		def subcategoriasList = Subcategoria.findAllByCategoria(categoriaInstance, [sort: "nombre", order: "asc"])
		render (template: "selectSubcategorias", model: [subcategoriasList: subcategoriasList, subcategoriaSeleccionada: params.int('subcategoriaSeleccionada')])
	}
