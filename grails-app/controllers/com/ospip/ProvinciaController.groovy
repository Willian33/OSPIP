...
class ProvinciaController {
	...
	def obtenerLocalidadesEmpleado = {
		def provinciaInstance = Provincia.get(params.int('id'))
		def localidadesList = Localidad.findAllByProvincia(provinciaInstance, [sort: "nombre", order: "asc"])
		render (template: "selectLocalidadesEmpleado", model: [localidadesList: localidadesList, localidadSeleccionada: params.int('localidadSeleccionada')])
	}
	
	def obtenerLocalidadesEmpresa = {
		def provinciaInstance = Provincia.get(params.int('id'))
		def localidadesList = Localidad.findAllByProvincia(provinciaInstance, [sort: "nombre", order: "asc"])
		render (template: "selectLocalidadesEmpresa", model: [localidadesList: localidadesList, localidadSeleccionada: params.int('localidadSeleccionada')])
	}
